...
#if defined(AES256) && (AES256 == 1)
const unsigned int Nk = 8;
const unsigned int Nr = 14;
#elif defined(AES192) && (AES192 == 1)
const unsigned int Nk = 6;
const unsigned int Nr = 12;
#else
const unsigned int Nk = 4;        // The number of 32 bit words in a key.
const unsigned int Nr = 10;       // The number of rounds in AES Cipher.
#endif

// state - array holding the intermediate results during decryption.
//typedef uint8_t state_t[4][4];

const unsigned int SDIMX = 4;
const unsigned int SDIMY = 4;

using state_t = uint8_t[SDIMX][SDIMY];
struct state_struct
{
  state_t buf;
};
